        ...
        <div className="collapse navbar-collapse text-center w-100" id="navbarNav">
          <ul className="navbar-nav m-auto my-2">
            <li className="nav-item">
              <NavLink className="nav-link text-light px-3" to="/">
                Home
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link text-light px-3" to="/product">
                Products
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link text-light px-3" to="/about">
                About
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link text-light px-3" to="/contact">
                Contact
              </NavLink>
            </li>
          </ul>
